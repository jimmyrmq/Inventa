...
public class ActionListenerMenu implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if(action.equals("PRODUCTO")){
            ...
            final boolean ver = !AppContext.getInstance().getBoolean("PanelProducto.mostrar",false);
            Thread thread = new Thread(()->{
        ...
        else if(action.equals("PROMOCION")){
            IPanelDesktop iPanelDesktop = new DesktopPromocion();
            //Global.panelDesktop.addVentana(iPanelDesktop, null);
        }

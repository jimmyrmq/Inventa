...
public class ModelTableProdPaqueteCustom implements IModelTableCustom<Producto> {
    ...
    private String[] columnName = {CONSTANTS.LANG.getValue("table.header.codigoproducto"),
            ...
            CONSTANTS.LANG.getValue("table.header.costo"),
            CONSTANTS.LANG.getValue("table.header.precio"),
            CONSTANTS.LANG.getValue("table.header.cantidad")
    };
    ...
    public int[] getWidthCell() {
        ...
        int[] anchoColum = {120, 180, 100,100,90};
        return anchoColum;
    }
